...
#SDCLANG_PATH := $(QC_PROP_ROOT)/llvm-arm-toolchain-ship/3.8/bin
...
PRODUCT_LIST += msmfalcon_64
PRODUCT_LIST += msmfalcon_32
...
ifneq (, $(filter $(PRODUCT_LIST), $(TARGET_PRODUCT)))
  ...
  ifneq ($(wildcard $(HY22_XML_CONF_PATH)),)
    PRODUCT_COPY_FILES := $(HY22_XML_CONF_PATH)/apns-conf.xml:system/etc/apns-conf.xml $(PRODUCT_COPY_FILES)
    PRODUCT_COPY_FILES := $(HY22_XML_CONF_PATH)/cdma_call_conf.xml:system/etc/cdma_call_conf.xml $(PRODUCT_COPY_FILES)
    PRODUCT_COPY_FILES := $(HY22_XML_CONF_PATH)/spn-conf.xml:system/etc/spn-conf.xml $(PRODUCT_COPY_FILES)
  endif
  ...
  ifneq ($(wildcard $(XML_CONF_PATH)),)
    ...
    PRODUCT_COPY_FILES := $(XML_CONF_PATH)/spn-conf.xml:system/etc/spn-conf.xml $(PRODUCT_COPY_FILES)
    PRODUCT_COPY_FILES := $(XML_CONF_PATH)/plmn-conf.xml:system/etc/plmn-conf.xml $(PRODUCT_COPY_FILES)
  endif
...
ifeq ($(call is-board-platform-in-list,msm8996 msm8994 msm8992 msm8952 msm8976 msm8937 msm8953 msm8998),true)
IMS_VT += librcc
endif
...
MM_AUDIO += QRD_SKU7_Bluetooth_cal.acdb
MM_AUDIO += QRD_SKU7_General_cal.acdb
MM_AUDIO += QRD_SKU7_Global_cal.acdb
MM_AUDIO += QRD_SKU7_Handset_cal.acdb
MM_AUDIO += QRD_SKU7_Hdmi_cal.acdb
MM_AUDIO += QRD_SKU7_Headset_cal.acdb
MM_AUDIO += QRD_SKU7_Speaker_cal.acdb
...
MM_CAMERA += libchromatix_imx179_3a_1640x924_30fps_preview_x3
MM_CAMERA += libchromatix_imx179_3a_1640x924_30fps_video
MM_CAMERA += libchromatix_imx179_3a_1640x924_30fps_video_x3
MM_CAMERA += libchromatix_imx179_3a_3280x1846_30fps_preview
MM_CAMERA += libchromatix_imx179_3a_3280x1846_30fps_preview_x3
MM_CAMERA += libchromatix_imx179_3a_3280x1846_30fps_video
MM_CAMERA += libchromatix_imx179_3a_3280x1846_30fps_video_x3
MM_CAMERA += libchromatix_imx179_3a_3280x2464_30fps_preview
MM_CAMERA += libchromatix_imx179_3a_3280x2464_30fps_preview_x3
MM_CAMERA += libchromatix_imx179_3a_3280x2464_30fps_video
MM_CAMERA += libchromatix_imx179_3a_3280x2464_30fps_video_x3
MM_CAMERA += libchromatix_imx179_3a_3280x2464_30fps_facebeauty
MM_CAMERA += libchromatix_imx179_3a_3280x2464_30fps_facebeauty_x3
...
MM_CAMERA += libchromatix_imx179_isp_1640x924_30fps_preview_x3
MM_CAMERA += libchromatix_imx179_isp_1640x924_30fps_snapshot
MM_CAMERA += libchromatix_imx179_isp_1640x924_30fps_snapshot_x3
MM_CAMERA += libchromatix_imx179_isp_1640x924_30fps_video
MM_CAMERA += libchromatix_imx179_isp_1640x924_30fps_video_x3
MM_CAMERA += libchromatix_imx179_isp_3280x1846_30fps_preview
MM_CAMERA += libchromatix_imx179_isp_3280x1846_30fps_preview_x3
MM_CAMERA += libchromatix_imx179_isp_3280x1846_30fps_snapshot
MM_CAMERA += libchromatix_imx179_isp_3280x1846_30fps_snapshot_x3
MM_CAMERA += libchromatix_imx179_isp_3280x1846_30fps_video
MM_CAMERA += libchromatix_imx179_isp_3280x1846_30fps_video_x3
MM_CAMERA += libchromatix_imx179_isp_3280x2464_30fps_facebeauty
MM_CAMERA += libchromatix_imx179_isp_3280x2464_30fps_facebeauty_x3
MM_CAMERA += libchromatix_imx179_isp_3280x2464_30fps_preview
MM_CAMERA += libchromatix_imx179_isp_3280x2464_30fps_preview_x3
MM_CAMERA += libchromatix_imx179_isp_3280x2464_30fps_snapshot
MM_CAMERA += libchromatix_imx179_isp_3280x2464_30fps_snapshot_x3
MM_CAMERA += libchromatix_imx179_isp_3280x2464_30fps_video
MM_CAMERA += libchromatix_imx179_isp_3280x2464_30fps_video_x3
...
MM_CAMERA += libactuator_rohm_bu63165gwl
MM_CAMERA += libois_rohm_bu63165gwl
#niqiangbo@camera add s5k3p8 @2016-07-28
MM_CAMERA += libchromatix_s5k3p8_common
MM_CAMERA += libchromatix_s5k3p8_cpp_hfr_120
MM_CAMERA += libchromatix_s5k3p8_cpp_hfr_60
MM_CAMERA += libchromatix_s5k3p8_cpp_hfr_90
MM_CAMERA += libchromatix_s5k3p8_cpp_liveshot
MM_CAMERA += libchromatix_s5k3p8_cpp_preview
MM_CAMERA += libchromatix_s5k3p8_cpp_snapshot
MM_CAMERA += libchromatix_s5k3p8_cpp_video
MM_CAMERA += libchromatix_s5k3p8_default_preview_bu64297
MM_CAMERA += libchromatix_s5k3p8_default_video
MM_CAMERA += libchromatix_s5k3p8_default_video_bu64297
MM_CAMERA += libchromatix_s5k3p8_hfr_120
MM_CAMERA += libchromatix_s5k3p8_hfr_120_bu64297
MM_CAMERA += libchromatix_s5k3p8_hfr_60
MM_CAMERA += libchromatix_s5k3p8_hfr_60_bu64297
MM_CAMERA += libchromatix_s5k3p8_hfr_90
MM_CAMERA += libchromatix_s5k3p8_hfr_90_bu64297
MM_CAMERA += libchromatix_s5k3p8_postproc
MM_CAMERA += libchromatix_s5k3p8_preview
MM_CAMERA += libchromatix_s5k3p8_snapshot
MM_CAMERA += libchromatix_s5k3p8_zsl_preview_bu64297
MM_CAMERA += libchromatix_s5k3p8_zsl_video_bu64297
MM_CAMERA += libmmcamera_s5k3p8
MM_CAMERA += libmmcamera_s5k3p8sp
MM_CAMERA += s5k3p8_chromatix.xml
MM_CAMERA += s5k3p8sp_chromatix.xml
MM_CAMERA += libmmcamera_s5k3p8sp_m24c64s_eeprom
#lukeho@camera add s5k3p8sp chromatix @2016-08-23
MM_CAMERA += libchromatix_s5k3p8sp_3a_2304x1728_30fps_preview
MM_CAMERA += libchromatix_s5k3p8sp_3a_2304x1728_30fps_video
MM_CAMERA += libchromatix_s5k3p8sp_3a_4608x3456_30fps_preview
MM_CAMERA += libchromatix_s5k3p8sp_3a_4608x3456_30fps_video
MM_CAMERA += libchromatix_s5k3p8sp_common_2304x1728
MM_CAMERA += libchromatix_s5k3p8sp_common_4608x3456
MM_CAMERA += libchromatix_s5k3p8sp_cpp_2304x1728_30fps_liveshot
MM_CAMERA += libchromatix_s5k3p8sp_cpp_2304x1728_30fps_preview
MM_CAMERA += libchromatix_s5k3p8sp_cpp_2304x1728_30fps_snapshot
MM_CAMERA += libchromatix_s5k3p8sp_cpp_2304x1728_30fps_video
MM_CAMERA += libchromatix_s5k3p8sp_cpp_4608x3456_30fps_liveshot
MM_CAMERA += libchromatix_s5k3p8sp_cpp_4608x3456_30fps_preview
MM_CAMERA += libchromatix_s5k3p8sp_cpp_4608x3456_30fps_snapshot
MM_CAMERA += libchromatix_s5k3p8sp_cpp_4608x3456_30fps_video
MM_CAMERA += libchromatix_s5k3p8sp_isp_2304x1728_30fps_preview
MM_CAMERA += libchromatix_s5k3p8sp_isp_2304x1728_30fps_snapshot
MM_CAMERA += libchromatix_s5k3p8sp_isp_2304x1728_30fps_video
MM_CAMERA += libchromatix_s5k3p8sp_isp_4608x3456_30fps_preview
MM_CAMERA += libchromatix_s5k3p8sp_isp_4608x3456_30fps_snapshot
MM_CAMERA += libchromatix_s5k3p8sp_isp_4608x3456_30fps_video
...
MM_CAMERA += libchromatix_imx298_common_60fps
MM_CAMERA += libchromatix_imx298_common_clearshot
...
MM_CAMERA += libchromatix_imx298_cpp_video_4k
MM_CAMERA += libchromatix_imx298_cpp_video_preview
MM_CAMERA += libchromatix_imx298_3a_panorama
MM_CAMERA += libchromatix_imx298_3a_panorama_s
MM_CAMERA += libchromatix_imx298_3a_clearshot
MM_CAMERA += libchromatix_imx298_3a_clearshot_s
MM_CAMERA += libchromatix_imx298_3a_HDR
MM_CAMERA += libchromatix_imx298_3a_HDR_s
MM_CAMERA += libchromatix_imx298_cpp_snapshot_clearshot
MM_CAMERA += libchromatix_imx298_4K_preview_s
MM_CAMERA += libchromatix_imx298_4K_video_s
MM_CAMERA += libchromatix_imx298_default_preview_s
MM_CAMERA += libchromatix_imx298_default_video_s
MM_CAMERA += libchromatix_imx298_hfr_120_3a_s
MM_CAMERA += libchromatix_imx298_hfr_60_3a_s
MM_CAMERA += libchromatix_imx298_hfr_90_3a_s
MM_CAMERA += libchromatix_imx298_zsl_preview_s
MM_CAMERA += libchromatix_imx298_zsl_video_s
#endif /* VENDOR_EDIT */

#ifdef VENDOR_EDIT /* motion detection */
MM_CAMERA += lib_oneplus_md
MM_CAMERA += libop_calib3d
MM_CAMERA += libop_core
MM_CAMERA += libop_face
MM_CAMERA += libop_features2d
MM_CAMERA += libop_flann
MM_CAMERA += libop_fuzzy
MM_CAMERA += libop_highgui
MM_CAMERA += libop_imgcodecs
MM_CAMERA += libop_imgproc
MM_CAMERA += libop_jasper
MM_CAMERA += libop_jpeg
MM_CAMERA += libop_openexr
MM_CAMERA += libop_png
MM_CAMERA += libop_tiff
MM_CAMERA += libop_ml
MM_CAMERA += libop_objdetect
MM_CAMERA += libop_optflow
MM_CAMERA += libop_photo
MM_CAMERA += libop_shape
MM_CAMERA += libop_stitching
MM_CAMERA += libop_structure_light
MM_CAMERA += libop_superpixel
MM_CAMERA += libop_superres
MM_CAMERA += libop_surface_matching
MM_CAMERA += libop_ts
MM_CAMERA += libop_videoio
MM_CAMERA += libop_video
MM_CAMERA += libop_videostab
MM_CAMERA += libop_world
MM_CAMERA += libop_xfeatures2d
MM_CAMERA += libop_ximgproc
MM_CAMERA += libop_xobjdetect
MM_CAMERA += libop_xphoto
MM_CAMERA += libop_xphoto
MM_CAMERA += libop_zlib
MM_CAMERA += libdnn
MM_CAMERA += libop_gpu
MM_CAMERA += libop_carotene
MM_CAMERA += libop_openxv
MM_CAMERA += libcaffe
MM_CAMERA += libprotobuf
#endif /* motion detection */

#ifdef VENDOR_EDIT /* face beauty */
MM_CAMERA += lib_oneplus_facebeauty
#endif /* face beauty */

#ifdef VENDOR_EDIT /* crypt */
MM_CAMERA += libopcamera_crypt
#endif /* crypt */
...
MM_CAMERA += libchromatix_ov7251_cpp_ds_chromatix
MM_CAMERA += libchromatix_ov7251_cpp_us_chromatix
MM_CAMERA += libchromatix_ov7251_default_preview_dw9714
MM_CAMERA += libchromatix_ov7251_default_video_dw9714
MM_CAMERA += libchromatix_ov7251_liveshot
MM_CAMERA += libchromatix_ov7251_liveshot_cpp
MM_CAMERA += libchromatix_ov7251_postproc
MM_CAMERA += libchromatix_ov7251_preview
MM_CAMERA += libchromatix_ov7251_preview_cpp
MM_CAMERA += libchromatix_ov7251_snapshot
MM_CAMERA += libchromatix_ov7251_snapshot_cpp
MM_CAMERA += libchromatix_ov7251_sw_post_proc
MM_CAMERA += libchromatix_ov7251_video
MM_CAMERA += libchromatix_ov7251_video_cpp
MM_CAMERA += libchromatix_ov7251_video_full
MM_CAMERA += libchromatix_ov7251_video_cpp_full
...
#VENDOR_EDIT
MM_CAMERA += libremosaic_tuning
MM_CAMERA += libremosaic_daemon
MM_CAMERA += remosaic_daemon
MM_CAMERA += qpd_dspcl_v2
MM_CAMERA += TC_Bayer_Converter_v6_core_opt
#ENDIF
...
QVR += libqvr_slpi_driver_stub
QVR += libqvr_slpi_driver_skel
QVR += libqvrservice
...
TELEPHONY_APPS += CdmaCallOptions
...
ifneq ($(wildcard $(QC_PROP_ROOT)/wlan/oem/oem-ss/Android.mk),)
WLAN += libwpa_drv_oem_ss.so
endif
...
SNAPDRAGON_SDK_DISPLAY += qdcm_calib_data_samsung_s6e3fa5_1080p_cmd_mode_dsi_panel.xml
