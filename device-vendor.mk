...
FINGERPRINT += template2.pgm
FINGERPRINT += template3.pgm
FINGERPRINT += template4.pgm
...
MM_AUDIO += libsrsprocessing_libs
...
MM_CAMERA += libopencv_calib3d
MM_CAMERA += libopencv_core
MM_CAMERA += libopencv_face
MM_CAMERA += libopencv_features2d
MM_CAMERA += libopencv_flann
MM_CAMERA += libopencv_fuzzy
MM_CAMERA += libopencv_highgui
MM_CAMERA += libopencv_imgcodecs
MM_CAMERA += libopencv_imgproc
MM_CAMERA += libopencv_libjasper
MM_CAMERA += libopencv_libjpeg
MM_CAMERA += libopencv_libopenexr
MM_CAMERA += libopencv_libpng
MM_CAMERA += libopencv_libtiff
MM_CAMERA += libopencv_ml
MM_CAMERA += libopencv_objdetect
MM_CAMERA += libopencv_optflow
MM_CAMERA += libopencv_photo
MM_CAMERA += libopencv_shape
MM_CAMERA += libopencv_stitching
MM_CAMERA += libopencv_structure_light
MM_CAMERA += libopencv_superpixel
MM_CAMERA += libopencv_superres
MM_CAMERA += libopencv_surface_matching
MM_CAMERA += libopencv_ts
MM_CAMERA += libopencv_videoio
MM_CAMERA += libopencv_video
MM_CAMERA += libopencv_videostab
MM_CAMERA += libopencv_world
MM_CAMERA += libopencv_xfeatures2d
MM_CAMERA += libopencv_ximgproc
MM_CAMERA += libopencv_xobjdetect
MM_CAMERA += libopencv_xphoto
MM_CAMERA += libopencv_xphoto
MM_CAMERA += libopencv_zlib
MM_CAMERA += libdnn
MM_CAMERA += libop_gpu
MM_CAMERA += libopencv_carotene
MM_CAMERA += libopencv_openxv
...
MM_CAMERA += libmmcamera_eztune_module
...
MM_CAMERA += libmmcamera_ppbase_module
...
MM_CAMERA += libmmcamera_thread_services
...
MM_CAMERA += libmmcamera2_memleak
...
MM_CAMERA_DBG += libmmcamera_wavelet_debug_32
